 ...
 * @author shuttle
 */
@WebServlet(name = "FindAccountServlet", urlPatterns = {"/findAccounts"})
public class FindAccountServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Account> accountsList = accountManager.findAccountsForCustomer(FIRST_NAME, LAST_NAME);

            out.printf("Bonjour.<br>Vous avez %d compte(s).", accountsList.size());
